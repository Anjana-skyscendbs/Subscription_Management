...
class SubService(models.Model):
    ...
    _inherits= {'subscription.subtype': 'service_id'}
    ...
    service_id = fields.Many2one('subscription.subtype', 'Service', required=True, ondelete='cascade')
...
class SubService2(models.Model):
    ...
    # It must have the required=True and ondelete='cascade'
    service_id = fields.Many2one('subscription.subtype',
                                  'Service',
                                  delegate=True,
                                  required=True,
                                  ondelete='cascade')
